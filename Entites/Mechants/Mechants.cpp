...
/*
Implémentation de la logique des quatre types de méchants
...
void Mechant2_1::update(struct Gamestate *gstate){
...
void Mechant2_2::update(struct Gamestate *gstate){
...
void Mechant3::update(struct Gamestate *gstate){
      ...
      {
            this -> lastShot = gstate -> time;
            this -> instanciateList.push_back(new Projectile(new Forme(posx, posy,"Formes/Models/Pr2.txt"),new Trajectoire(-100,283,0,0,0,0,0,0,0,0),ENTITE_P_MECHANT));
...
void Mechant4::update(struct Gamestate *gstate){
      ...
      {
            this -> lastShot = gstate -> time;
            this -> instanciateList.push_back(new Projectile(new Forme(posx, posy,"Formes/Models/Pr4.txt"),new Trajectoire(0,300,0,0,0,0,0,0,0,0),ENTITE_P_MECHANT));
            this -> instanciateList.push_back(new Projectile(new Forme(posx, posy,"Formes/Models/Pr4.txt"),new Trajectoire(0,-300,0,0,0,0,0,0,0,0),ENTITE_P_MECHANT));
            this -> instanciateList.push_back(new Projectile(new Forme(posx, posy,"Formes/Models/Pr4.txt"),new Trajectoire(300,0,0,0,0,0,0,0,0,0),ENTITE_P_MECHANT));
            this -> instanciateList.push_back(new Projectile(new Forme(posx, posy,"Formes/Models/Pr4.txt"),new Trajectoire(-300,0,0,0,0,0,0,0,0,0),ENTITE_P_MECHANT));
