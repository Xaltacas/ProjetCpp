...
SFMLFLAGS_OBJ =
ALL.O = main.o Mechant.o Trajectoire.o JoueurPhysique.o Forme.o Brique.o Jeu.o Menu.o Script.o
ALL.H = Trajectoires/Trajectoire.hpp Entites/Mechants/Mechant.hpp Entites/Joueurs/JoueurPhysique.hpp Entites/Joueurs/Joueur.hpp Formes/Brique.hpp Formes/Forme.hpp Etats/Jeu.hpp Etats/Menu.hpp Etats/Etat.hpp Other/Script.hpp Other/Gamestate.hpp
...
#Mechants/
Mechant.o: Entites/Mechants/Mechant.cpp  Entites/Mechants/Mechant.hpp Trajectoires/Trajectoire.hpp Entites/Projectiles/Projectile.hpp
	$(CC) -c $< $(WFLAGS)
...
#Etats/
Jeu.o: Etats/Jeu.cpp Etats/Jeu.hpp Etats/Etat.hpp Other/Gamestate.hpp Other/Script.hpp
	$(CC) -c $< $(WFLAGS) $(SFMLFLAGS_OBJ)
